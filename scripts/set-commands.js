...
const commands = [
  ...
  { command: 'startsecondarylist', description: 'بدء قائمة تصحيح التلاوة بتسجيل ذاتي، ومع التجميد يُتاح تسجيل احتياطي (للمشرف)' },
  ...
  { command: 'freezelist', description: 'تجميد تسجيل الحضور؛ ويبقى التسجيل الاحتياطي متاحاً في تصحيح التلاوة (للمشرف)' },
  { command: 'editlist', description: 'تعديل حالات الحضور (للمشرف)' },
  { command: 'stoplist', description: 'إنهاء الجلسة الحالية (للمشرف)' },
  ...
  { command: 'pendingstudents', description: 'مراجعة طلبات التسجيل (وتشمل الضيوف الذين سجّلوا أنفسهم) وقبولها أو تجاهلها (للمشرف)' },
