...
const commands = [
  ...
  { command: 'addteacher', description: 'إضافة معلمة (للمشرف)' },
  ...
  { command: 'editlist', description: 'تعديل حالات الحضور للطالبات (للمشرف)' },
  { command: 'studentshistory', description: 'سجل الطالبات حسب الدورة (الحالية افتراضياً) (للمشرف)' },
