 ...
 *   { name, memberId, isGuest, status, called, page, verse, registeredAt, attendedMain }
 *
 * Design rules:
 ...
 */
export function register(session, name, { memberId, status, registeredAt, attendedMain } = {}) {
