...
import { groupIdFromCtx, replyEphemeral, splitEntries } from '../../helpers.js';
...
export function register(bot, storage) {
  const { getMaster, saveMaster, getSession, saveSession, getPendingRegistrations, savePendingRegistrations } = storage;
