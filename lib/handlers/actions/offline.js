...
export function renderTeachers(cls, teachers) {
  ...
  // Each teacher is a tappable button (label shows all her roles) that opens her
  // menu. A teacher may hold several roles, so she appears once with them joined.
  for (const t of list) {
    const typeLabel = TEXT.teacherTypesLabel(t.types);
