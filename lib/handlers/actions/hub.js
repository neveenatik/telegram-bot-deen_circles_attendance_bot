...
import { groupIdFromCtx, replyEphemeral, logTelegramError, beginForceReplyAwaiting } from '../../helpers.js';
...
export const GROUP_TEACHER_TYPES = ['courseteacher', 'trainingteacher', 'recitationteacher'];
...
export function createHandlers({ storage, telegram }) {
  const { getMaster, getPendingRegistrations, getAllSessions, getCurrentSeries, getTeachers, saveTeachers, setReplyPrompt } = storage;
