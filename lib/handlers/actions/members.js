...
export function register(bot, storage) {
  const { getMaster, saveMaster, getActiveSession, getSession, saveSession, setAwaiting, getAwaiting, getPendingRegistrations, savePendingRegistrations, getTeachers, saveTeachers } = storage;
