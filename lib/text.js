...
export const TEXT = {
  ...
  materials: {
    ...
    filesHint: 'اضغطي على اسم الملف لمعاينته، أو على 🗑 لحذفه.',
...
`.trim(),
  ...
  offline: {
    ...
    teachersManageHint: 'المعلمات مرتّبات حسب الدور. اضغطي على اسم المعلمة لتعديل اسمها أو أدوارها أو حذفها. (قد تظهر المعلمة تحت أكثر من دور.)',
    teacherSectionOther: '— بدون دور محدد —',
