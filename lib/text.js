...
export const TEXT = {
  ...
  manageHub: {
    ...
    homeworkButton: '📓 التكليفات',
    offlineButton: '🧑‍🏫 صفوف بدون مجموعة',
    backButton: '↩️ لوحة الإدارة',
    // The only string the interactive editor can't borrow from TEXT.offline:
  ...
  materials: {
    ...
    manageHint: 'اضغطي على مادة لإدارتها، أو أضيفي مادة جديدة.',
    empty: '🤍 لا توجد مواد تعليمية بعد. أضيفي أول مادة عبر الزر بالأعلى، بارك الله فيكِ.',
    addButton: '➕ إضافة مادة',
    addPrompt:
      '📎 أرسلي الملف (مستند، صورة، فيديو، أو مقطع صوتي) واكتبي *عنوان المادة* في تعليق الملف (caption).\n\nالعنوان المكتوب في التعليق سيصبح اسم المادة.',
    noCaption: '⚠️ لم أجد عنواناً للمادة. أعيدي إرسال الملف مع كتابة العنوان في تعليق الملف (caption).',
    unsupportedType: '⚠️ نوع الملف غير مدعوم. أرسلي مستنداً أو صورة أو فيديو أو مقطعاً صوتياً.',
    added: (title) => `✅ تمت إضافة المادة: *${title}*`,
    itemMenuTitle: (title) => `📄 *${title}*\n\nاختاري إجراءً:`,
    sendToGroupButton: '📤 إرسال إلى المجموعة',
    sendToMeButton: '📥 إرسال إليّ',
    sentToGroup: '✅ تم إرسال المادة إلى المجموعة',
    sentToMe: '✅ تم إرسال المادة إليكِ',
    sendFailed: '⚠️ تعذّر إرسال المادة. حاولي مرة أخرى.',
    removeButton: '🗑️ حذف',
    removeConfirm: (title) => `⚠️ هل تريدين حذف المادة *${title}*؟`,
    confirmRemoveButton: '🗑️ تأكيد الحذف',
    removedToast: (title) => `تم حذف ${title}`,
    missing: '⚠️ المادة غير موجودة.',
    caption: (title) => `📚 *${title}*`,
  },
  homework: {
    ...
    counts: (submitted, total, reviewed) => `سلّمن: ${submitted}/${total} • روجِعت: ${reviewed}`,
    legend: 'المفتاح: ✅ روجِعت • 📝 سُلِّمت • ⬜️ لم تُسلَّم',
    ...
    manageHint: 'اضغطي على اسم الطالبة لتبديل حالة التسليم، أو اضغطي مطوّلاً على زر المراجعة.',
...
`.trim(),
  ...
  offline: {
    ...
    teachersManageHint: 'اضغطي على اسم المعلمة لتعديل اسمها أو نوعها أو حذفها.',
    ...
    changeTeacherTypeButton: '🔀 تغيير النوع',
    ...
    pickTeacherTypeTitle: (name) => `🔀 *اختاري نوع المعلمة ${name}:*`,
    teacherTypeChanged: (typeLabel) => `✅ تم تغيير النوع إلى *${typeLabel}*.`,
