...
export const TEXT = {
  ...
  historyMemberVerseLine: (verse) => `🧾 الآية الحالية: ${verse || '—'}`,
  ...
  reciteConfirmButton: '✅ أُقِرّ بالتعهدات الثلاث',
  reciteAttestationFooter:
    `📿 للتسجيل في تصحيح التلاوة، بالضغط على الزر أدناه فإنكِ تُقرِّين بالتعهدات الثلاثة:\n` +
    `١. حضرتُ الحلقة الأساسية مع المعلمه نهى عيد.\n` +
    `٢. استمعتُ للشيخ قبل المشاركة فى الحلقه.\n` +
    `٣. لم أشارك بعد في حلقة تصحيح تلاوة هذا الأسبوع.`,
