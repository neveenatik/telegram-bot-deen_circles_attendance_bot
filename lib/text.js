...
export const TEXT = {
  ...
  timetable: {
    ...
    removeConfirm: (day, time, typeLabel) =>
      `⚠️ هل تريدين حذف موعد *${typeLabel}* يوم ${day} الساعة ${time}؟`,
    confirmRemoveButton: '🗑️ تأكيد الحذف',
    ...
    myWeekSlotLineTz: (time, tzLabel, className, typeLabel, teacher) =>
      `• ${time} (${tzLabel}) — ${className} · ${typeLabel}${teacher ? ` (${teacher})` : ''}`,
    ...
    tzButton: '🌍 تغيير التوقيت',
    tzPickTitle: '🌍 اختاري المنطقة الزمنية للحلقة. تُعرض كل مواعيد الجدول بهذا التوقيت.',
    tzUpdated: '✅ تم تحديث التوقيت.',
  },
