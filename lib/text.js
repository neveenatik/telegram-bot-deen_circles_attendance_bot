...
export const TEXT = {
  ...
  myIdInfo: '🪪 هذا رقم حسابك في تيليغرام. أرسلي السطر التالي للمشرفة لتضيفك بسهولة:',
  registerWidgetText: `📢 *طلب الانضمام لقائمة المسجلات*\n\nحياكن الله يا غاليات، وبارك الله فيكن.\n\nللتسجيل يكفي الضغط على الزر أدناه مرة واحدة فقط.\n\nبعد ذلك يصل طلبك إلى المشرفات، ثم يقمن بقبول الطلب أو تأجيله.\n\nإذا ظهر لك أن الطلب تم إرساله، فلا يلزمك أي إجراء آخر.`,
