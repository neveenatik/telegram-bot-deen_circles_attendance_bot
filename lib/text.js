...
export const TEXT = {
  ...
  invalidAddTeacherFormat: '⚠️ الصيغة الصحيحة: /addteacher [معرّف] | [اسم] | [نوع]\nالأنواع المتاحة: courseteacher | trainingteacher | recitationteacher',
  invalidRemoveTeacherFormat: '⚠️ الصيغة الصحيحة: /removeteacher [اسم]',
  invalidAssignTeacherFormat: '⚠️ الصيغة الصحيحة: /assignteacher [اسم] | [نوع]',
  ...
  help: (admin) =>
    ...
    (admin
      ? `\n\n*للمشرف:*\n` +
        ...
        `/contact [رسالتك] – الإبلاغ عن مشاكل تقنية أو اقتراحات (يُرسل بشكل مجهول الهوية)\n`
      : ''),
  attendance: {
    present: { e: '✅', a: 'حاضرة' },
...
*أمثلة [جيدة]:*
\`/contact عند استخدام /editlist، حالة الحضور لا تُحفظ\`
\`/contact /startlist لا يعرض أزرار الحضور في الرسالة\`

*نصيحة:* اذكر الأمر المستخدم والمشكلة والسلوك المتوقع ✓

✅ رسالتك ستُرسل مجهولة الهوية مع طابع التاريخ فقط
`.trim(),
  contactThankYou: '✅ شكراً! تم إرسال رسالتك بنجاح (مجهول الهوية)',
  contactError: '❌ حدث خطأ. يرجى المحاولة لاحقاً',
