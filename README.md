...
| `/addteacher [معرّف] \| [الاسم] \| [النوع]` | إضافة معلمة: courseteacher, trainingteacher, recitationteacher (للمشرف) |
| `/removeteacher [الاسم]` | حذف معلمة (للمشرف) |
| `/assignteacher [الاسم] \| [النوع]` | تغيير نوع المعلمة (للمشرف) |
