...
| `/startpagelist [اسم] \| [صفحة البداية]` | بدء قائمة قراءة ختمة فردية – كل طالبة تسجّل وتحصل على رقم صفحة تلقائياً ( رقم الصفحة الافتراضي 1) |
| `/startgrouprecitation [اسم]` | بدء ختمة جماعية  – كل طالب يحصل على صفحة واحدة متسلسلة (يتم حفظ الصفحة تلقائيا للحلقة الموالية) |
